...
Future<Message> fetchMessage() async {
  final response =
      await http.get('http://3.140.179.89:5000/get-msg?message_type=Covid');
...
void main() => runApp(CovidMessage());

class CovidMessage extends StatefulWidget {
  CovidMessage({Key key}) : super(key: key);

  @override
  _CovidMessage createState() => _CovidMessage();
}

class _CovidMessage extends State<CovidMessage> {
