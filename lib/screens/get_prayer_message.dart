...
Future<Message> fetchMessage() async {
  final response =
      await http.get('http://3.140.179.89:5000/get-msg?message_type=Prayer');
...
void main() => runApp(PrayerMessage());

class PrayerMessage extends StatefulWidget {
  PrayerMessage({Key key}) : super(key: key);

  @override
  _PrayerMessage createState() => _PrayerMessage();
}

class _PrayerMessage extends State<PrayerMessage> {
