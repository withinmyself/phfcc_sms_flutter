...
class ChangeMeetingsMessage extends StatefulWidget {
  @override
  _ChangeMeetingsMessageState createState() => _ChangeMeetingsMessageState();
}

// state class
// We will replace this class in each of the examples below
class _ChangeMeetingsMessageState extends State<ChangeMeetingsMessage> {
  // state variable
  String _textString = ' ';
  String _sendResult = ' ';
  ...
  void _changeMessage(_textString) {
    http.get(
        'http://3.140.179.89:5000/change-msg?message_type=Meetings&message=$_textString');
        _sendResult = '''
        Meetings message has been changed.
